...
all: system-check benchmark_client benchmark_server

benchmark_client: benchmark.pb.o benchmark_client.o
	$(CXX) $^ $(LDFLAGS) -o $@

benchmark_server: benchmark.pb.o benchmark_server.o
	$(CXX) $^ $(LDFLAGS) -o $@
...
clean:
	rm -f *.o *.pb.cc *.pb.h benchmark_client benchmark_server
